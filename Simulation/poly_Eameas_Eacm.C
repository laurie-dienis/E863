...
void poly_Eameas_Eacm(){
    ...
    double EbeamEntry = 1.2*39.948;// MeV
  ...
  /*  double exitWindow_width = 0.020; //mm
    ...
    int N_energy = 132;
    int extraction_data;
    Double_t EnergyRecoil[2][132];     Double_t RangeRecoil_in_4He[2][132];    Double_t SPelRecoil_in_4He[2][132];    Double_t SPnuRecoil_in_4He[2][132];
    Double_t EnergyRecoil_window[2][132];     Double_t RangeRecoil_in_4He_window[2][132];    Double_t SPelRecoil_in_4He_window[2][132];    Double_t SPnuRecoil_in_4He_window[2][132];
    //40Ar
 ...
 for(int i=0;i<2;i++){
    ...
    for(int b=0;b<Nbeam;b++){
        ...
        //std::cout<< Ebeam <<" Ebeam after target  "<<std::endl;
        ...
        Ebeam = Ebeam - ELossBeam;
	//
        //std::cout<< Ebeam <<" Ebeam after gas "<<std::endl;
        ...
        for(int j=0;j<Nreac;j++){
            ...
            if(eEjectil_lab>0 && thetaEjectil_lab<angle_max_Si && compteur_reaction==0){
                ...
                //std::cout<< ElossRecoil <<" Elossalpha window "<<std::endl;
