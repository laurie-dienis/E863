...
double MCsim(const Char_t *fileCS, int Nsim[3], double EbeamEntry,
  ...
  srim->ReadTable("beam_window","/home/laurie/Analysis_e863/Inputs/SRIM/15O_Ti.txt");
  srim->ReadTable("beam_gas", TString::Format("/home/laurie/Analysis_e863/Inputs/SRIM/15O_4He_%iTorr.txt", pressure_target).Data());
...
void MC15O4He() {
  ...
  std::cout << "Début de MC15O4He()" << std::endl;
  ...
  //***************************************
  const Char_t *fileCS[2] = {
      "azure_results/cs180degLatest.dat",
      "azure_results/cs180degWO6441.dat",
  };
  Double_t Ecm[25000];
  Double_t Ex[25000];
