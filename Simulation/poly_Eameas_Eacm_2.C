...
void poly_Eameas_Eacm_2(){
  ...
  srim->ReadTable(
      "beam",
      TString::Format(
          "/home/laurie/Analysis_e863/Inputs/SRIM/15O_4He_%dTorr.txt", aivalable_pressure_target[choice_pressure_target])
          .Data());
  srim->ReadTable(
      "beam_window","/home/laurie/Analysis_e863/Inputs/SRIM/15O_Ti.txt");
    
    //***************************************
    //Reaction initialization
    //***************************************
    double mu = 931.5;
    double m15O = 15 * mu +2.855 ;
    double m4He = 4 * mu + 2.425;
    double mu4He=m4He /(m4He + m15O);
    double mu150=m15O /(m4He + m15O);
