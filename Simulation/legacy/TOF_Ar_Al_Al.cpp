...
void TOF_Ar_Al_Al() {
	...
	std::mt19937_64 rng2;
	std::uniform_real_distribution<double> unif2(23.01,103.01);
    
	// definition of the 2D and 1D spectra
    TH2F *h1 = new TH2F("h1","",800,0,20,800,0,100); // impulsion as a function of the energy
    TH2F *h2 = new TH2F("h2","",800,0,20,800,0,100); // impulsion as a function of the energy
    TF1 *data = new TF1("data","[0]*x^[1]", 8, 20);
    data->SetParameter(0, 2.8517934);
    data->SetParameter(1, 1.343756977);		
