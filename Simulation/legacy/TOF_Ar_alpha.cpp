...
// *******  LOOP ******************************************
    for (Int_t n=0;n<iter;n++) {
        ...
        double TOF_b = 28.6/vb + unif(rng);  //28.6 is the distance for which we measure the TOF
        ...
        double TOF_s = 28.6/vs+ unif(rng);  //28.6 is the distance for which we measure the TOF
