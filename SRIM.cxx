...
Physics::SRIM::SRIM(const std::string& key, const std::string& file)
{
    ReadTable(key, file);
}

bool Physics::SRIM::IsBreakLine(const std::string& line)
{
    int count {};
    int pos {};
...
double Physics::SRIM::ConvertToDouble(std::string& str, const std::string& unit)
{
...
Physics::SRIM::PtrSpline
Physics::SRIM::GetSpline(std::vector<double>& x, std::vector<double>& y, const std::string& name)
{
    return std::make_shared<TSpline3>(name.c_str(), &(x[0]), &(y[0]), x.size(), "b2,e2", 0., 0.);
}

Physics::SRIM::PtrGraph
Physics::SRIM::GetGraph(std::vector<double>& x, std::vector<double>& y, const std::string& name)
{
...
void Physics::SRIM::ReadTable(const std::string& key, const std::string& file)
{
...
void Physics::SRIM::ReadInterpolations(std::string key, std::string fileName)
{
...
double Physics::SRIM::Slow(const std::string& material, double Tini, double thickness, double angleInRad)
{
    // Init range
...
double Physics::SRIM::SlowWithStraggling(const std::string& material, double Tini, double thickness,
...
double
Physics::SRIM::EvalInitialEnergy(const std::string& material, double Tafter, double thickness, double angleInRad)
{
    // After range
...
bool Physics::SRIM::CheckKeyIsStored(const std::string& key)
{
    return std::find(fKeys.begin(), fKeys.end(), key) != fKeys.end();
}

void Physics::SRIM::ReadConfiguration(std::shared_ptr<ActRoot::InputBlock> block)
{
...
void Physics::SRIM::ReadConfiguration(const std::string& file)
{
