...
SRIM::SRIM(const std::string& key, const std::string& file)
{
    ReadTable(key, file);
}

bool SRIM::IsBreakLine(const std::string& line)
{
    int count {};
    int pos {};
...
double SRIM::ConvertToDouble(std::string& str, const std::string& unit)
{
...
SRIM::PtrSpline
SRIM::GetSpline(std::vector<double>& x, std::vector<double>& y, const std::string& name)
{
    return std::make_unique<TSpline3>(name.c_str(), &(x[0]), &(y[0]), x.size(), "b2,e2", 0., 0.);
}

void SRIM::ReadTable(const std::string& key, const std::string& file)
{
...
void SRIM::ReadInterpolations(std::string key, std::string fileName)
{
...
void SRIM::Draw(const std::string& what, const std::vector<std::string>& keys)
{
...
double SRIM::Slow(const std::string& material, double Tini, double thickness, double angleInRad)
{
    // Init range
...
double
SRIM::EvalInitialEnergy(const std::string& material, double Tafter, double thickness, double angleInRad)
{
    // After range
...
bool SRIM::CheckKeyIsStored(const std::string& key)
{
